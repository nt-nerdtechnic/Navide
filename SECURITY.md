...
```
[Agent-Team] Security Vulnerability
```
...
> 請以郵件聯絡 **nt.nerdtechnic@gmail.com**，主旨：`[Agent-Team] Security Vulnerability`。  
...
Agent-Team runs entirely on your local machine:
...
> Agent-Team 完全在本機執行，不傳送任何遙測資料，不需要帳號，不儲存 API key。  

...
[Download v0.1.51](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.51) | [Getting started](docs/en-US/getting-started.md) | [Documentation](docs/en-US/README.md) | [Roadmap](docs/en-US/roadmap.md)
...
Navide supports macOS 13+ on Apple silicon. The v0.1.51 release is signed with a Developer ID certificate and notarized by Apple:

- [Download DMG](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.51/Navide-0.1.51-arm64.dmg)
- [Download ZIP](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.51/Navide-0.1.51-arm64.zip)

...
[Download v0.2.5](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.2.5) | [Getting started](docs/en-US/getting-started.md) | [Documentation](docs/en-US/README.md) | [Roadmap](docs/en-US/roadmap.md)
...
- [Download Windows x64 installer](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.5/Navide-0.2.5-win-x64.exe) ([mirror](https://dl.navide.dev/releases/v0.2.5/Navide-0.2.5-win-x64.exe))
- [Download Windows Arm64 installer](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.5/Navide-0.2.5-win-arm64.exe) ([mirror](https://dl.navide.dev/releases/v0.2.5/Navide-0.2.5-win-arm64.exe))
- [Download Linux AppImage](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.5/Navide-0.2.5-x86_64.AppImage) ([mirror](https://dl.navide.dev/releases/v0.2.5/Navide-0.2.5-x86_64.AppImage)) · [Download Linux .deb](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.5/Navide-0.2.5-amd64.deb) ([mirror](https://dl.navide.dev/releases/v0.2.5/Navide-0.2.5-amd64.deb))

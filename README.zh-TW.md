...
Navide 支援配備 Apple 晶片且執行 macOS 13 以上版本的 Mac。v0.1.50 為經 Developer ID 簽章並通過 Apple Notarization 的正式版本：

- [下載 DMG](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.50/Navide-0.1.50-arm64.dmg)
- [下載 ZIP](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.50/Navide-0.1.50-arm64.zip)

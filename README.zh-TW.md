...
[下載 v0.1.44 Preview](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.44) | [開始使用](docs/zh-TW/getting-started.md) | [文件中心](docs/zh-TW/README.md) | [Roadmap](docs/zh-TW/roadmap.md)
...
Navide 支援配備 Apple 晶片且執行 macOS 13 以上版本的 Mac。v0.1.44 Preview 提供未簽章版本下載：

- [下載 DMG](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/Navide-0.1.44-arm64.dmg)
- [下載 ZIP](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/Navide-0.1.44-arm64.zip)
- [核對 SHA-256 Checksum](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/SHA256SUMS.txt)

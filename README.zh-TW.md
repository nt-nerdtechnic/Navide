...
[下載 v0.2.6](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.2.6) | [開始使用](docs/zh-TW/getting-started.md) | [文件中心](docs/zh-TW/README.md) | [Roadmap](docs/zh-TW/roadmap.md)
...
Navide 支援配備 Apple 晶片且執行 macOS 13 以上版本的 Mac、Linux x64，以及 x64／Arm 版 Windows。v0.2.6 提供經 Developer ID 簽章並通過 Apple Notarization 的 macOS 版本，以及 Windows x64 安裝程式與 Linux x64 套件：

- [下載 DMG](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-arm64.dmg) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-arm64.dmg))
- [下載 ZIP](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-arm64.zip) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-arm64.zip))
- [下載 Windows x64 安裝程式](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-win-x64.exe) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-win-x64.exe))
- [下載 Windows ARM64 安裝程式](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-win-arm64.exe) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-win-arm64.exe))
- [下載 Linux AppImage](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-x86_64.AppImage) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-x86_64.AppImage))・[下載 Linux .deb](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.2.6/Navide-0.2.6-amd64.deb) ([鏡像](https://dl.navide.dev/releases/v0.2.6/Navide-0.2.6-amd64.deb))

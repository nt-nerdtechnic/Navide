...
[下載 v0.1.46 Preview](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.46) | [開始使用](docs/zh-TW/getting-started.md) | [文件中心](docs/zh-TW/README.md) | [Roadmap](docs/zh-TW/roadmap.md)
...
Navide 支援配備 Apple 晶片且執行 macOS 13 以上版本的 Mac。v0.1.46 Preview 提供未簽章版本下載：

- [下載 DMG](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.46/Navide-0.1.46-arm64.dmg)
- [下載 ZIP](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.46/Navide-0.1.46-arm64.zip)
- [核對 SHA-256 Checksum](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.46/SHA256SUMS.txt)

此 Preview 尚未經 Apple 簽章或 Notarization。將 Navide 複製到「應用程式」後，請在 Finder 中按住 Control 點擊 App，再選擇「打開」。若 macOS 仍阻擋執行，前往「系統設定 → 隱私權與安全性」，針對 Navide 選擇「強制打開」。請勿停用整個系統的 Gatekeeper。

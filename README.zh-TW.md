...
[English](README.md) | [繁體中文](README.zh-TW.md) | [Manifesto](docs/manifesto.md) | [Vision](docs/vision.md) | [文件中心](docs/README.md) | [Roadmap](docs/roadmap.md)
...
產品方向代表設計意圖，不表示功能已經交付，也不是交付日期承諾。詳細範圍與完成條件請見 [Product Roadmap](docs/roadmap.md)。
...
處理敏感程式碼、憑證、YOLO 或 Full Auto 前，請閱讀 [Privacy and Data Flows](docs/privacy.md) 與 [Security Policy](SECURITY.md)。

## 試用 Navide

Navide 目前支援 macOS 13 以上版本，並以原始碼方式安裝；尚未發布正式簽章公開版本。
...
- [The Navide Manifesto](docs/manifesto.md) — 為什麼 Agent 時代需要新的工程利器
- [Product Vision](docs/vision.md) — 目標使用者、產品原則、運作模型與成功定義
- [Product Positioning](docs/product-positioning.md) — 產品類別、訊息層次、用詞與公開主張邊界
- [Product Roadmap](docs/roadmap.md) — 從現有系統走向完整環境的方向性路徑
- [文件中心](docs/README.md) — 使用者、貢獻者、架構、隱私與參考指南

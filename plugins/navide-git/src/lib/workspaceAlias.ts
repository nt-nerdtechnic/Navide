 ...
 *  — `tests/sharedOwnershipBoundary.test.ts` fails any `src/renderer`
 *  specifier — and the Host's key-normalisation and alias-map helpers are of
 *  no use here: the Host resolves the alias and hands this bundle the finished
 *  string in `?workspace_display_name=`.
 *

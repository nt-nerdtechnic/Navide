...
.ch-main { width: min(820px, calc(100vw - 72px)); margin: 0 auto; padding: 38px 0; overflow: auto; }
...
.ch-footer { display: flex; align-items: center; gap: 10px; margin-top: auto; padding: 18px 44px; border-top: 1px solid var(--border-muted); }

...
[v0.1.44 Preview をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.44) | [はじめに](docs/ja-JP/getting-started.md) | [ドキュメント](docs/ja-JP/README.md) | [ロードマップ](docs/ja-JP/roadmap.md)
...
Navide は Apple silicon 上の macOS 13 以降をサポートします。v0.1.44 Preview は未署名 Build として提供されています。

- [DMG をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/Navide-0.1.44-arm64.dmg)
- [ZIP をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/Navide-0.1.44-arm64.zip)
- [SHA-256 Checksum を確認](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.44/SHA256SUMS.txt)

この Preview は Apple による署名も Notarization も行われていません。Navide を Applications にコピーした後、Finder でアプリを Control-click し、**開く**を選択してください。それでも macOS にブロックされる場合は、**システム設定 → プライバシーとセキュリティ**で Navide の**このまま開く**を選択します。Gatekeeper をシステム全体で無効化しないでください。

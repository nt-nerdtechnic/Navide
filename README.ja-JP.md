...
[v0.1.43 Preview をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.43) | [はじめに](docs/ja-JP/getting-started.md) | [ドキュメント](docs/ja-JP/README.md) | [ロードマップ](docs/ja-JP/roadmap.md)
...
Navide は Apple silicon 上の macOS 13 以降をサポートします。v0.1.43 Preview は未署名 Build として提供されています。

- [DMG をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.43/Navide-0.1.43-arm64.dmg)
- [ZIP をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.43/Navide-0.1.43-arm64.zip)
- [SHA-256 Checksum を確認](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.43/SHA256SUMS.txt)

...
[v0.1.52 をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.52) | [はじめに](docs/ja-JP/getting-started.md) | [ドキュメント](docs/ja-JP/README.md) | [ロードマップ](docs/ja-JP/roadmap.md)
...
Navide は Apple silicon 上の macOS 13 以降をサポートします。v0.1.52 は Developer ID で署名され、Apple の Notarization を通過した正式版です。

- [DMG をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.52/Navide-0.1.52-arm64.dmg)
- [ZIP をダウンロード](https://github.com/nt-nerdtechnic/Navide/releases/download/v0.1.52/Navide-0.1.52-arm64.zip)

...
Navide は Apple silicon 上の macOS 13 以降をサポートします。[v0.1.46 GitHub Prerelease](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.46) では、未署名の DMG と ZIP を提供しています。Apple による署名も Notarization も行われていません。

...
Navide 支援配備 Apple 晶片且執行 macOS 13 以上版本的 Mac。[v0.1.42 GitHub Prerelease](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.42) 提供未簽章的 DMG 與 ZIP 下載；這些檔案尚未經 Apple 簽章或 Notarization。

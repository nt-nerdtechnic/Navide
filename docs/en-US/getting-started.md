...
Navide supports macOS 13 or newer on Apple silicon. The [v0.1.41 GitHub prerelease](https://github.com/nt-nerdtechnic/Navide/releases/tag/v0.1.41) provides unsigned DMG and ZIP downloads. It is not signed or notarized by Apple.

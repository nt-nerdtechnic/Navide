...
SNAPSHOT = [{'id': 'claude',
 ...
 {'id': 'aider',
  ...
  'platforms': [],
  'install_cmds': {}},
 # Appended after the snapshot was taken: cliproxyapi is absent from
 # _AGENT_CLI_ORDER, so it sorts with the other unordered vendors, in
 # registry (alphabetical) order — before droid and muse below.
 {'id': 'cliproxyapi',
  'label': 'CLIProxyAPI',
  'description': 'Multi-provider AI proxy (Claude/Codex/Antigravity/Kimi/xAI accounts behind one OpenAI-compatible endpoint)',
  'group': 'agent_cli',
  'check_cmd': ['CLIProxyAPI', '--help'],
  'version_regex': 'CLIProxyAPI Version:\\s*(\\S+),',
  'alt_commands': [],
  'min_version': '',
  'install_cmd': '',

...
for every entry but cursor, whose version pattern is anchored for the same
reason."""
...
SNAPSHOT = [{'id': 'claude',
 ...
 {'id': 'mcode',
  ...
  'group': 'agent_cli',
  'check_cmd': ['mcode', '--version'],
  'version_regex': '(\\d+\\.\\d+\\.\\d+)',
  'alt_commands': [],
  'identity_regex': '',
  'min_version': '',
  'install_cmd': 'npm install -g @minimax-ai/code',
  'needs_terminal': True,
  'optional': True,
  ...
  'update_state_file': '',
  'config_home_env': 'MINIMAX_DATA_DIR',
  'config_home_default': '.minimax',
  'autoupdate_env': '',
  'platforms': [],
  'install_cmds': {}},
 {'id': 'muse',
